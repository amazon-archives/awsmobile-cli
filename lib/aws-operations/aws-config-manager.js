...
function initialize(projectInfo){ 
    return awsConfigManagerBase.initializeAWSForNewProject(projectInfo)
}
...
function getAWSConfigFilePath(projectInfo){
    ...
    let awsConfigFilePath = path.join(pathManager.getSysAWSMobileJSDirPath(), awsInfo.ConfigFileName)
