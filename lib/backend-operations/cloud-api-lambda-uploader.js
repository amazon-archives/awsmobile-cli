...
function uploadLambdaZipFiles(projectInfo, awsConfig, backendProjectDetails, featureName, callback){
    ...
    if(fs.existsSync(_featureBuildDirPath)){
        ...
        let s3 = awsClient.S3(_projectInfo, getDeploymentBucketRegion(deploymentBucket))
