...
function setAppSyncJS(projectPath, appSyncJs){
  let appsyncJSFilePath = pathManager.getAppSyncJSFilePath(projectPath)

  let appsyncJS ={
    graphqlEndpoint: appSyncJs.graphqlEndpoint,
    region: appSyncJs.region,
    authenticationType: appSyncJs.authenticationType
  }

  if(appSyncJs.apiKey){
    appsyncJS.apiKey = appSyncJs.apiKey
  }
