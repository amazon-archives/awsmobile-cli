...
function onSuccess(appsyncCreationHandle){
  let appsyncInfo = projectInfoManager.getAppSyncInfo(appsyncCreationHandle.projectInfo)
  let appsyncInfoUpdate = constructAppSyncInfo(appsyncCreationHandle)
  Object.assign(appsyncInfo, appsyncInfoUpdate)
  projectInfoManager.updateAppSyncInfo(appsyncCreationHandle.projectInfo, appsyncInfo)
