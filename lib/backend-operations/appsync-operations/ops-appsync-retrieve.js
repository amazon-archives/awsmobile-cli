...
function logAppsyncJS(appsyncRetrieveHandle){
  let appsyncExports = constructAppSyncExports(appsyncRetrieveHandle)
  appsyncManager.setAppsyncJS(appsyncRetrieveHandle.projectInfo.ProjectPath, appsyncExports)
  projectInfoManager.updateAppSyncDetails(appsyncRetrieveHandle.projectInfo, appsyncExports)
}

function constructAppSyncExports(appsyncRetrieveHandle)
{
  let result = {}
