...
function createDDBTables(appsyncUpdateHandle){
  spinner.start('updating appsync: create DynamoDB tables' + chalk.blue('(this may take a while)'))
...
function updateDDBTables(appsyncUpdateHandle){
  spinner.start('updating appsync: update DynamoDB tables' + chalk.blue('(this may take a while)'))
...
function onSuccess(appsyncUpdateHandle){
  spinner.stop()
  console.log('appsync update successful')
