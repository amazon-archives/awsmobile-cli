...
function createDataSources(appsyncUpdateHandle){
  console.log('appsync update: create data sources...')
...
function deleteDataSources(appsyncUpdateHandle){
  console.log('appsync update: deleteDataSources...')
...
function createResolvers(appsyncUpdateHandle){
  ...
  appsyncUpdateHandle.appSyncInfoDiff.resolvers.forEach(resolver => {
...
function deleteResolvers(appsyncUpdateHandle){
  console.log('appsync update: deleteResolvers...')
...
function createApiKeys(appsyncUpdateHandle){
  ...
  appsyncUpdateHandle.appSyncInfoDiff.apiKeys.forEach(apiKey => {
...
function createApiKey(appsyncUpdateHandle, apiKey){
  return new Promise((resolve, reject) => {
    ...
    param.description = apiKey.description ? apiKey.description : undefined
    param.expires = apiKey.description ? apiKey.description : undefined
...
function deleteApiKeys(appsyncUpdateHandle){
  console.log('appsync update: deleteApiKeys...')
