...
const appsyncCreate = require('./appsync-operations/appsyncop-create.js')
const appsyncRetrieve = require('./appsync-operations/appsyncop-retrieve.js')
const appsyncUpdate = require('./appsync-operations/appsyncop-update.js')
const appsyncDelete = require('./appsync-operations/appsyncop-delete.js')
