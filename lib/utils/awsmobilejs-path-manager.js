...
function getAWSConfigFilePath(awsInfo)
{
    return path.normalize(path.join(getSysAWSMobileJSDirPath(), awsInfo.ConfigFileName))
}

function getAWSInfoFilePath_base()
{
    return path.normalize(path.join(getSysAWSMobileJSDirPath(), awsmobileJSConstant.AWSInfoFileName))
}

function getAWSConfigFilePath_base()
{
...
module.exports = {
    ...
    getAWSInfoFilePath_base,
    getAWSConfigFilePath_base,
