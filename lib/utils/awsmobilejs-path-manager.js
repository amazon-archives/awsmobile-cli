...
{
    return path.normalize(path.join(getDotAWSMobileDirPath(projectPath), awsmobileJSConstant.ProjectInfoFileName))
}

function getInfoDirPath_v_1_0_3(projectPath)
{
...
function getProjectInfoFilePath_v_1_0_3(projectPath)
{
    return path.normalize(path.join(getInfoDirPath_v_1_0_3(projectPath), awsmobileJSConstant.ProjectInfoFileName))
}
...
module.exports = {
    ...
    getProjectInfoFilePath_v_1_0_3,
