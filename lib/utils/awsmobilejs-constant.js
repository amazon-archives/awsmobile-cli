...
module.exports = {
    ...
    "https://console.aws.amazon.com/iam/home?region=us-east-1#/users$new?step=review&accessKey&userNames=AWSMobileCLI&permissionType=policies&policies=arn:aws:iam::aws:policy%2FAWSMobileHub_FullAccess&policies=arn:aws:iam::aws:policy%2FAWSDeviceFarmFullAccess&policies=arn:aws:iam::aws:policy%2FAWSLambdaFullAccess&policies=arn:aws:iam::aws:policy%2FIAMReadOnlyAccess"
}