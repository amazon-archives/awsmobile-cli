...
var AppDOType = new yaml.Type('!com.amazonaws.mobilehub.v0.AppDO', {
  kind: 'mapping',
  construct: function(data) { 
    return new AppDO(data)
  },
  instanceOf: AppDO
})
...
var YML_SCHEMA = yaml.Schema.create([AppDOType, ProjectType, DatabaseType, UserSettingsType,
...
var createYamlText = (yamlDefinition) => {
  ...
  let regExpAppDO = new RegExp('\!<\!com.amazonaws.mobilehub.v0.AppDO>', 'g');
  ...
  yamlText = yamlText.replace(regExpAppDO, '!com.amazonaws.mobilehub.v0.AppDO');
...
var yamlLoad = () => {
  ...
  return yaml.safeLoad(data, { schema: YML_SCHEMA, noCompatMode: true, scalarType: 5 });
};
  ...
  load: function (projectInfo, callback) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (yaml) {  
        ...
        reject('No yaml file present in project');
      }
    });
  },
