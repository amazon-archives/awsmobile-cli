...
var createYamlStructure = (projectDefinition) => {
  ...
  Object.keys(projectDefinition.cloudlogic.apis).map(apiKey => {
    ...
    if (typeof api.signInRequired != "undefined") {
      attributes['requires-signin'] = api.signInRequired
    }

    if (typeof api['api-arn'] != 'undefined') {
      attributes['api-arn'] = api['api-arn'];
    }

    if (typeof api['sdk-generation-stage-name'] != 'undefined') {
      attributes['sdk-generation-stage-name'] = api['sdk-generation-stage-name'];
    }
...
var createApiJsonStructure = (yamlDefinition) => {
  ...
  Object.keys(components).map(apiKey => {
    ...
    if (components[apiKey]['attributes']) {
      currentApi['signInRequired'] = components[apiKey]['attributes']['requires-signin'] || false;

      if (typeof components[apiKey]['attributes']['api-arn'] != 'undefined') {
        currentApi['api-arn'] = components[apiKey]['attributes']['api-arn'];
      }

      if (typeof components[apiKey]['attributes']['sdk-generation-stage-name'] != 'undefined') {
        currentApi['sdk-generation-stage-name'] = components[apiKey]['attributes']['sdk-generation-stage-name'];
      }
    }
