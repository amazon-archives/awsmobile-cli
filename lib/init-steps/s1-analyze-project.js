...
function run(initInfo){
    return new Promise((resolve, reject)=>{
        if(fs.existsSync(initInfo.projectPath)){
            ...
            initInfo.projectInfo = getProjectInfo(projectPath)
            initInfo.projectConfig = getProjectConfig(projectPath)
            initInfo.backendProject = getBackendProject(projectPath)
            initInfo.packageJson = getPackageJson(projectPath)
