         ...
         mobile.describeProject(param, function(err,data){
             ...
             if(err){
                 ...
                 if(data && data.details){
                     ...
                     console.log()
                     backendInfoManager.syncCurrentBackendInfo(projectInfo, data.details, awsDetails.config, syncToDevFlag, function(){
                        if(callback){
                            callback()
                        }
                     })
...
function getLatestBackendDetails(mobileProjectID, callback){
    awsConfigManager.checkAWSConfig(function(awsDetails){
         let mobile = awsClient.Mobile()
