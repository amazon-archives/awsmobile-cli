...
function linkToBackend(projectInfo, mobileProjectID, syncToDevFlag, callback){
    awsConfigManager.checkAWSConfig(projectInfo, function(awsConfig){
         let mobile = awsClient.Mobile(projectInfo)
...
function pullBackend(projectInfo, mobileProjectID, syncToDevFlag, callback){
    awsConfigManager.checkAWSConfig(projectInfo, function(awsConfig){
         let mobile = awsClient.Mobile(projectInfo)
...
function getLatestBackendDetails(projectInfo, callback){
    const mobileProjectID = projectInfo.BackendProjectID
    awsConfigManager.checkAWSConfig(projectInfo, function(awsConfig){
         let mobile = awsClient.Mobile(projectInfo)
