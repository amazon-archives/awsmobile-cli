    ...
    awsConfigManager.checkAWSConfig(function(awsDetails){
        ...
        inquirer.prompt([
            ...
            if(answers.mobileProjectName){
                ...
                let backendContents = fs.readFileSync(pathManager.getProjectCreationContentZipFilePath())
                let param = {
                ...
                mobile.createProject(param, function(err,data){
                    ...
                    if(err){
                        ...
                        if(data && data.details){
                            ...
                            console.log()
                            backendInfoManager.syncCurrentBackendInfo(projectInfo, data.details, awsDetails, 1, function(){
                                if(callback){
                                    callback()
                                }
                            })
