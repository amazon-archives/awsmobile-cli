...
function npmInstallUi(folder) {
  spawnSync('npm', ['install', '--save', 'aws-sdk', 'link-react', 'axios', 'semantic-ui-react', 'react-file-input'], {cwd: folder, env: process.env, stdio: 'inherit'});
}
