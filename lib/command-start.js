...
function setupBackend(projectInfo, contentZipFilePath, callback){
    backendCreate.createBackendProject(projectInfo, contentZipFilePath, function(){
...
function printWelcomeMessage(projectInfo){
    let greetingMessage = 'Success! your have created project ' + projectInfo.ProjectName
    if(_starterName){
        greetingMessage += ' using awsmobilejs starter ' + _starterName
    }
